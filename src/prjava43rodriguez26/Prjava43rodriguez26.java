package prjava43rodriguez26; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.io.*; 

// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43rodriguez26 extends Frame 
   ...
   public Prjava43rodriguez26 () { 
      ...
      setTitle("nova finestra prjava43rodriguez26");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43rodriguez26();  // Let the construct do the job 
   } 
